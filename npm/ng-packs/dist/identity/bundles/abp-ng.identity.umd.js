(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(
        ...
        require('@abp/ng.permission-management'),
        require('primeng/table'),
        require('@ngx-validate/core'),
      )
    : typeof define === 'function' && define.amd
    ? define('@abp/ng.identity', [
        'exports',
        '@abp/ng.core',
        '@angular/core',
        '@ngxs/store',
    ...
    : ((global = global || self),
      factory(
        ((global.abp = global.abp || {}), (global.abp.ng = global.abp.ng || {}), (global.abp.ng.identity = {})),
        global.ng_core,
        global.ng.core,
        global.store,
        ...
        global.snq,
        global.ngBootstrap,
        global.ng_permissionManagement,
        global.table,
        global.core$1,
      ));
})(this, function(
  ...
  var IdentityService = /** @class */ (function() {
    ...
    /** @nocollapse */ IdentityService.ngInjectableDef = core.ɵɵdefineInjectable({
      factory: function IdentityService_Factory() {
        return new IdentityService(core.ɵɵinject(ng_core.RestService));
      },
     ...
     */ = function(_a, _b) {
      ...
      return dispatch(new GetRoleById(payload.id)).pipe(
        operators.switchMap(
           ...
           */
          function() {
            return _this.identityService.updateRole(__assign({}, getState().selectedRole, payload));
          },
        ),
        operators.switchMap(
          /**
     ...
     */ = function(_a, _b) {
      ...
      return dispatch(new GetUserById(payload.id)).pipe(
        operators.switchMap(
           ...
           */
          function() {
            return _this.identityService.updateUser(__assign({}, getState().selectedUser, payload));
          },
        ),
        operators.switchMap(
          /**
  ...
  var RolesComponent = /** @class */ (function() {
    ...
    RolesComponent.ctorParameters = function() {
      return [{ type: ng_theme_shared.ConfirmationService }, { type: forms.FormBuilder }, { type: store.Store }];
    };
    RolesComponent.propDecorators = {
      modalContent: [{ type: core.ViewChild, args: ['modalContent', { static: false }] }],
    };
    __decorate(
      [store.Select(IdentityState.getRoles), __metadata('design:type', rxjs.Observable)],
      RolesComponent.prototype,
      'data$',
      void 0,
    );
    __decorate(
      [store.Select(IdentityState.getRolesTotalCount), __metadata('design:type', rxjs.Observable)],
      RolesComponent.prototype,
      'totalCount$',
      void 0,
    );
  ...
  var RoleResolver = /** @class */ (function() {
    ...
    RoleResolver.decorators = [{ type: core.Injectable }];
    /** @nocollapse */
    RoleResolver.ctorParameters = function() {
  ...
  var UsersComponent = /** @class */ (function() {
     ...
     */ = function() {
      ...
      if (!this.selected.userName) {
        this.form.addControl(
          'password',
          new forms.FormControl('', [forms.Validators.required, forms.Validators.maxLength(32)]),
        );
      }
    };
    /**
    ...
    __decorate(
      [store.Select(IdentityState.getUsers), __metadata('design:type', rxjs.Observable)],
      UsersComponent.prototype,
      'data$',
      void 0,
    );
    __decorate(
      [store.Select(IdentityState.getUsersTotalCount), __metadata('design:type', rxjs.Observable)],
      UsersComponent.prototype,
      'totalCount$',
      void 0,
    );
  ...
  var UserResolver = /** @class */ (function() {
    ...
    UserResolver.decorators = [{ type: core.Injectable }];
    /** @nocollapse */
    UserResolver.ctorParameters = function() {
      return [{ type: store.Store }];
    };
    return UserResolver;
  })();
