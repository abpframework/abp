(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    ? define('@abp/ng.feature-management', [
        'exports',
        '@abp/ng.core',
        '@abp/ng.theme.shared',
        '@angular/core',
    ...
    : ((global = global || self),
      factory(
        ...
        (global.abp.ng['feature-management'] = {})),
        global.ng_core,
...
})(this, function(exports, ng_core, ng_theme_shared, core, store, rxjs, operators, forms) {
  'use strict';
  ...
  var FeatureManagementService = /** @class */ (function() {
    ...
    FeatureManagementService.ctorParameters = function() {
      return [{ type: ng_core.RestService }, { type: store.Store }];
    };
    /** @nocollapse */ FeatureManagementService.ngInjectableDef = core.ɵɵdefineInjectable({
      factory: function FeatureManagementService_Factory() {
        return new FeatureManagementService(core.ɵɵinject(ng_core.RestService), core.ɵɵinject(store.Store));
      },
  ...
  var FeatureManagementComponent = /** @class */ (function() {
    ...
    __decorate(
      [store.Select(FeatureManagementState.getFeatures), __metadata('design:type', rxjs.Observable)],
        ...
        args: [
          {
            ...
            imports: [
              ...
              store.NgxsModule.forFeature([FeatureManagementState]),
            ],
