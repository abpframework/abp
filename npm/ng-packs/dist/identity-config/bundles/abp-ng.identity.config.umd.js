(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('@abp/ng.core'), require('@angular/core'), require('@angular/router'))
    : typeof define === 'function' && define.amd
    ? define('@abp/ng.identity.config', ['exports', '@abp/ng.core', '@angular/core', '@angular/router'], factory)
    : ((global = global || self),
      factory(
        ((global.abp = global.abp || {}),
        (global.abp.ng = global.abp.ng || {}),
        (global.abp.ng.identity = global.abp.ng.identity || {}),
        (global.abp.ng.identity.config = {})),
        global.ng_core,
        global.ng.core,
        global.ng.router,
      ));
})(this, function(exports, ng_core, core, router) {
  'use strict';
