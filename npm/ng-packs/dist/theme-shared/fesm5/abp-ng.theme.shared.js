...
/** @type {?} */
var fadeOut = animation([style({ opacity: '1' }), animate('{{ time}} {{ easing }}', style({ opacity: '0' }))], {
  params: { time: '350ms', easing: 'ease' },
});
/** @type {?} */
...
var ProfileComponent = /** @class */ (function() {
  ...
  ProfileComponent.ctorParameters = function() {
    return [{ type: FormBuilder }, { type: Store }];
  };
      ...
      function(res) {
        ...
        if (err instanceof HttpErrorResponse && err.headers.get('_AbpErrorFormat')) {
          ...
          switch (/** @type {?} */ (err).status) {
            case 401:
              _this
                .showError(DEFAULT_ERROR_MESSAGES.defaultError401.details, DEFAULT_ERROR_MESSAGES.defaultError401.title)
                .subscribe(
                  /**
                   * @return {?}
                   */
