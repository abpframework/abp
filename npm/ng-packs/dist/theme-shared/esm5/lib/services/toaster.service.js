   ...
   */ = function(messages) {
    ...
    this.messageService.addAll(
      messages.map(
         ...
         */
        function(message) {
          return tslib_1.__assign({ key: _this.key }, message);
        },
      ),
    );
  };
  ToasterService.decorators = [{ type: Injectable, args: [{ providedIn: 'root' }] }];
  /** @nocollapse */ ToasterService.ngInjectableDef = i0.ɵɵdefineInjectable({
    factory: function ToasterService_Factory() {
      return new ToasterService(i0.ɵɵinject(i1.MessageService));
    },
