(function(global, factory) {
  ...
  var ApplicationLayoutComponent = /** @class */ (function() {
     ...
     */ = function() {
      ...
      this.store.dispatch(
        new routerPlugin.Navigate(['/'], null, {
    ...
    ApplicationLayoutComponent.ctorParameters = function() {
      return [{ type: store.Store }, { type: angularOauth2Oidc.OAuthService }];
    };
    ApplicationLayoutComponent.propDecorators = {
      ...
      navbarRootDropdowns: [
        { type: core.ViewChildren, args: ['navbarRootDropdown', { read: ngBootstrap.NgbDropdown }] },
      ],
    };
    __decorate(
    ...
    __decorate(
      [store.Select(ng_core.ConfigState.getDeep('localization.languages')), __metadata('design:type', rxjs.Observable)],
      ApplicationLayoutComponent.prototype,
      'languages$',
      void 0,
    );
    __decorate(
      [store.Select(LayoutState.getNavigationElements), __metadata('design:type', rxjs.Observable)],
      ApplicationLayoutComponent.prototype,
      'navElements$',
      void 0,
    );
  ...
  var InitialService = /** @class */ (function() {
    ...
    InitialService.decorators = [{ type: core.Injectable, args: [{ providedIn: 'root' }] }];
    /** @nocollapse */
    InitialService.ctorParameters = function() {
      return [{ type: ng_core.LazyLoadService }];
    };
    /** @nocollapse */ InitialService.ngInjectableDef = core.ɵɵdefineInjectable({
      factory: function InitialService_Factory() {
        return new InitialService(core.ɵɵinject(ng_core.LazyLoadService));
      },
