!(function(t, e) {
    ...
    return (
      ...
      t.length
        ? t
            ...
            .map(function(t) {
              return t.children && t.children.length && (t.children = z(t.children)), t;
            })
        : []
    );
  }
  ...
  var Z = (function() {
    ...
    return (
      ...
      (t.prototype.setTenantId = function(t, e) {
  ...
  var W = (function() {
    ...
    return (
      ...
      (t.prototype.patchRoute = function(t, e) {
        ...
        return n({
          routes: (a = (function t(e, n, r, o) {
            ...
            e = e.map(function(e) {
              return e.name === n
                ? (r.path && (r.url = o + '/' + r.path),
                  r.children &&
                    r.children.length &&
                    (r.children = r.children.map(function(t) {
                      return m({}, t, { url: o + '/' + e.path + '/' + t.path });
                    })),
                  m({}, e, r))
      ...
      (t = e = b([r.State({ name: 'ConfigState', defaults: {} }), S('design:paramtypes', [F, r.Store])], t))
    );
  })();
  function X(t) {
  ...
  var ut = (function() {
    ...
    return (
      ...
      (t.prototype.profileGet = function(t) {
        var e = t.patchState;
      ...
      (t.prototype.profileUpdate = function(t, e) {
        var n = t.patchState,
          r = e.payload;
  ...
  var Rt = new e.InjectionToken('NGXS_CONFIG_PLUGIN_OPTIONS'),
    It = (function() {
      function t(t, e) {
      ...
      return (
        ...
        (t.decorators = [{ type: e.Injectable }]),
        (t.ctorParameters = function() {
          return [{ type: void 0, decorators: [{ type: e.Inject, args: [Rt] }] }, { type: n.Router }];
        }),
        t
      );
    })();
  ...
  var Pt = (function() {
    ...
    return (
      ...
      (t.prototype.getOne = function(t) {
        return this.store.selectSnapshot(W.getOne(t));
      }),
      (t.prototype.getDeep = function(t) {
        return this.store.selectSnapshot(W.getDeep(t));
      }),
      (t.prototype.getSetting = function(t) {
        return this.store.selectSnapshot(W.getSetting(t));
      }),
      (t.decorators = [{ type: e.Injectable, args: [{ providedIn: 'root' }] }]),
      (t.ctorParameters = function() {
        return [{ type: r.Store }];
  ...
  var wt = new e.InjectionToken('ENVIRONMENT'),
    Et = new e.InjectionToken('CONFIG'),
    At = (function() {
      function t(t, n) {
  ...
  var Lt = { provide: e.LOCALE_ID, useClass: Dt, deps: [$] },
    xt = (function() {
      function t() {}
      return (
        (t.forRoot = function(n) {
          return (
            void 0 === n && (n = {}),
            {
              ...
              providers: [
                Lt,
                { provide: r.NGXS_PLUGINS, useClass: It, multi: !0 },
            ...
            args: [
              {
                ...
                declarations: [K, J, Y, tt, rt, it, pt, St, st, ct, lt, At, Ct, P],
                exports: [
                  c.CommonModule,
                  u.HttpClientModule,
                  l.FormsModule,
  ...
  (t.AbstractNgModelComponent = P),
    (t.ApiInterceptor = bt),
    (t.ApplicationConfigurationService = F),
    (t.AuthGuard = ft),
    ...
    (t.NGXS_CONFIG_PLUGIN_OPTIONS = Rt),
    ...
    (t.addAbpRoutes = function(t) {
      Array.isArray(t) || (t = [t]), M.push.apply(M, O(t));
    }),
