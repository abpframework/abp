(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = global || self),
      factory(
        ((global.abp = global.abp || {}), (global.abp.ng = global.abp.ng || {}), (global.abp.ng.core = {})),
        global.ng.core,
        global.ng.router,
        global.store,
        global.rxjs,
  ...
  var RestService = /** @class */ (function() {
     ...
     */ = function(request, config, api) {
      var _this = this;
      config = config || /** @type {?} */ ({});
      var _a = config.observe,
        observe = _a === void 0 ? 'body' /* Body */ : _a,
        skipHandleError = config.skipHandleError;
      /** @type {?} */
      var url = (api || this.store.selectSnapshot(ConfigState.getApiUrl())) + request.url;
      var method = request.method,
        options = __rest(request, ['method']);
      return this.http.request(method, url, /** @type {?} */ (__assign({ observe: observe }, options))).pipe(
        observe === 'body' /* Body */ ? operators.take(1) : operators.tap(),
    ...
    RestService.ctorParameters = function() {
      return [{ type: http.HttpClient }, { type: store.Store }];
    };
    /** @nocollapse */ RestService.ngInjectableDef = core.ɵɵdefineInjectable({
      factory: function RestService_Factory() {
        return new RestService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(store.Store));
      },
      token: RestService,
      providedIn: 'root',
    });
  ...
  var ApplicationConfigurationService = /** @class */ (function() {
    ...
    /** @nocollapse */ ApplicationConfigurationService.ngInjectableDef = core.ɵɵdefineInjectable({
      factory: function ApplicationConfigurationService_Factory() {
        return new ApplicationConfigurationService(core.ɵɵinject(RestService));
      },
      token: ApplicationConfigurationService,
      providedIn: 'root',
    });
  ...
  function registerLocale(locale) {
    return import(
      ...
      '@angular/common/locales/' + (localesMapping[locale] || locale) + '.js'
    ).then(
      /**
       * @param {?} module
       * @return {?}
  ...
  var LocalizationService = /** @class */ (function() {
            ...
            function() {
              return __awaiter(_this, void 0, void 0, function() {
                return __generator(this, function(_a) {
                  switch (_a.label) {
                    case 0:
                      return [4 /*yield*/, this.router.navigateByUrl(this.router.url).catch(rxjs.noop)];
                    case 1:
                      _a.sent();
     ...
     */ = function(key) {
      ...
      return this.store.selectSnapshot(
        ConfigState.getLocalization.apply(ConfigState, __spread([key], interpolateParams)),
      );
    };
    LocalizationService.decorators = [{ type: core.Injectable, args: [{ providedIn: 'root' }] }];
    /** @nocollapse */
    ...
    /** @nocollapse */ LocalizationService.ngInjectableDef = core.ɵɵdefineInjectable({
      factory: function LocalizationService_Factory() {
        return new LocalizationService(
          core.ɵɵinject(store.Store),
          core.ɵɵinject(router.Router),
          core.ɵɵinject(core.NgZone),
          core.ɵɵinject(LocalizationService, 12),
        );
      },
     ...
     */ = function(_a, _b) {
      ...
      return dispatch(new GetAppConfiguration()).pipe(
        operators.switchMap(
           ...
           */
          function() {
            return rxjs.from(_this.localizationService.registerLocale(payload));
          },
        ),
      );
    };
  ...
  var ConfigState = /** @class */ (function() {
    ...
    ConfigState.ctorParameters = function() {
      return [{ type: ApplicationConfigurationService }, { type: store.Store }];
    };
    __decorate(
      [
  ...
  var DynamicLayoutComponent = /** @class */ (function() {
    ...
    DynamicLayoutComponent.ctorParameters = function() {
      return [{ type: router.Router }, { type: router.ActivatedRoute }, { type: store.Store }];
    };
    __decorate(
      [store.Select(ConfigState.getOne('requirements')), __metadata('design:type', rxjs.Observable)],
  ...
  function findLayout(segments, routes) {
    ...
    var route = routes
      .reduce(
         ...
         */
        (function(acc, val) {
          return val.wrapper ? __spread(acc, val.children) : __spread(acc, [val]);
        }),
        [],
      )
      .find(
  ...
  var AutofocusDirective = /** @class */ (function() {
     ...
     */ = function() {
      ...
      setTimeout(
         ...
         */
        function() {
          return _this.elRef.nativeElement.focus();
        },
        this.delay,
      );
    };
  ...
  var EllipsisDirective = /** @class */ (function() {
    ...
    EllipsisDirective.ctorParameters = function() {
      return [{ type: core.ChangeDetectorRef }, { type: core.ElementRef }];
    };
  ...
  var ForDirective = /** @class */ (function() {
    ...
    ForDirective.ctorParameters = function() {
      return [{ type: core.TemplateRef }, { type: core.ViewContainerRef }, { type: core.IterableDiffers }];
    };
  ...
  var ProfileService = /** @class */ (function() {
    ...
    /** @nocollapse */ ProfileService.ngInjectableDef = core.ɵɵdefineInjectable({
      factory: function ProfileService_Factory() {
        return new ProfileService(core.ɵɵinject(RestService));
      },
      ...
      if (this.condition) {
        this.store
          ...
          .subscribe(
            ...
            function(isGranted) {
              if (!isGranted) {
                _this.renderer.removeChild(
                  /** @type {?} */ (_this.elRef.nativeElement).parentElement,
  ...
  var TableSortDirective = /** @class */ (function() {
    ...
    TableSortDirective.ctorParameters = function() {
      return [{ type: table.Table, decorators: [{ type: core.Optional }, { type: core.Self }] }, { type: SortPipe }];
    };
  ...
  var VisibilityDirective = /** @class */ (function() {
    ...
    VisibilityDirective.ctorParameters = function() {
      return [{ type: core.ElementRef, decorators: [{ type: core.Optional }] }, { type: core.Renderer2 }];
    };
  ...
  var AuthGuard = /** @class */ (function() {
    ...
    AuthGuard.ctorParameters = function() {
      return [{ type: angularOauth2Oidc.OAuthService }, { type: router.Router }];
    };
    /** @nocollapse */ AuthGuard.ngInjectableDef = core.ɵɵdefineInjectable({
      factory: function AuthGuard_Factory() {
        return new AuthGuard(core.ɵɵinject(angularOauth2Oidc.OAuthService), core.ɵɵinject(router.Router));
      },
      token: AuthGuard,
      providedIn: 'root',
    });
  ...
  var PermissionGuard = /** @class */ (function() {
    ...
    /** @nocollapse */ PermissionGuard.ngInjectableDef = core.ɵɵdefineInjectable({
      factory: function PermissionGuard_Factory() {
        return new PermissionGuard(core.ɵɵinject(store.Store));
      },
      ...
      return next
        ...
        .pipe(
          operators.finalize(
             ...
             */
            function() {
              return _this.store.dispatch(new StopLoader(request));
            },
          ),
        );
    };
    ApiInterceptor.decorators = [{ type: core.Injectable }];
    /** @nocollapse */
    ApiInterceptor.ctorParameters = function() {
      return [{ type: angularOauth2Oidc.OAuthService }, { type: store.Store }];
    };
        ...
        ConfigState.getLocalization.apply(
          ...
          __spread(
            ...
            interpolateParams.reduce(
               ...
               */
              function(acc, val) {
                return Array.isArray(val) ? __spread(acc, val) : __spread(acc, [val]);
              },
              [],
            ),
          ),
  ...
  var ConfigPlugin = /** @class */ (function() {
     ...
     */ = function(state, event, next) {
      ...
      if (isInitAction && !this.initialized) {
        ...
        state = store.setValue(
          state,
          'ConfigState',
          __assign({}, state.ConfigState && __assign({}, state.ConfigState), this.options, {
            routes: routes,
    ...
    ConfigPlugin.decorators = [{ type: core.Injectable }];
    /** @nocollapse */
  ...
  function transformRoutes(routes, wrappers) {
    ...
    var oldAbpRoutes = routes
      ...
      .reduce(
         ...
         */
        (function(acc, val) {
          return __spread(acc, val.data.routes.routes);
        }),
        [],
      );
      ...
      .forEach(
        ...
        function(route) {
          ...
          if (transformed.length === length && (route.data || {}).routes) {
            transformed.push(
              /** @type {?} */ (__assign({}, route.data.routes, {
                path: route.path,
                name: snq(
                  /**
                   * @return {?}
  ...
  var LazyLoadService = /** @class */ (function() {
    ...
    /** @nocollapse */ LazyLoadService.ngInjectableDef = core.ɵɵdefineInjectable({
  ...
  var ClickEventStopPropagationDirective = /** @class */ (function() {
    ...
    /** @nocollapse */
    ClickEventStopPropagationDirective.ctorParameters = function() {
      return [{ type: core.Renderer2 }, { type: core.ElementRef }];
    };
