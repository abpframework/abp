...
var TenantsComponent = /** @class */ (function() {
  ...
  __decorate(
    [Select(TenantManagementState.get), __metadata('design:type', Observable)],
    TenantsComponent.prototype,
    'data$',
    void 0,
  );
  __decorate(
    [Select(TenantManagementState.getTenantsTotalCount), __metadata('design:type', Observable)],
    TenantsComponent.prototype,
    'totalCount$',
    void 0,
  );
...
var TenantsResolver = /** @class */ (function() {
  ...
  TenantsResolver.decorators = [{ type: Injectable }];
  /** @nocollapse */
