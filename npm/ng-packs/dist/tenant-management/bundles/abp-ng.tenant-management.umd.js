(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(
        ...
        require('@abp/ng.feature-management'),
        require('@ngx-validate/core'),
      )
    : typeof define === 'function' && define.amd
    ? define('@abp/ng.tenant-management', [
        'exports',
        '@abp/ng.core',
        '@abp/ng.theme.shared',
        '@angular/core',
    ...
    : ((global = global || self),
      factory(
        ...
        (global.abp.ng['tenant-management'] = {})),
        global.ng_core,
  ...
  var TenantManagementService = /** @class */ (function() {
    ...
    /** @nocollapse */ TenantManagementService.ngInjectableDef = core.ɵɵdefineInjectable({
      factory: function TenantManagementService_Factory() {
        return new TenantManagementService(core.ɵɵinject(ng_core.RestService));
      },
  ...
  var TenantManagementState = /** @class */ (function() {
     ...
     */ = function(_a, _b) {
      ...
      return dispatch(new GetTenantById(payload.id)).pipe(
        operators.switchMap(
           ...
           */
          function() {
            return _this.tenantManagementService.updateTenant(__assign({}, getState().selectedItem, payload));
          },
        ),
        operators.switchMap(
          /**
    ...
    TenantManagementState.ctorParameters = function() {
      return [{ type: TenantManagementService }];
    };
    __decorate(
      [
  ...
  var TenantsComponent = /** @class */ (function() {
     ...
     */ = function(id) {
      ...
      this.store
        ...
        .pipe(
          operators.pluck('TenantManagementState', 'selectedItem'),
          operators.switchMap(
            /**
             * @param {?} selected
             * @return {?}
        ...
        .subscribe(
          ...
          function(fetchedConnectionString) {
            ...
            _this.openModal(
              ...
              _this.connectionStringModalTemplate,
              'saveConnStr',
            );
          },
        );
    ...
    TenantsComponent.propDecorators = {
      ...
      connectionStringModalTemplate: [
        { type: core.ViewChild, args: ['connectionStringModalTemplate', { static: false }] },
      ],
    };
    __decorate(
      [store.Select(TenantManagementState.get), __metadata('design:type', rxjs.Observable)],
      TenantsComponent.prototype,
      'data$',
      void 0,
    );
    __decorate(
      [store.Select(TenantManagementState.getTenantsTotalCount), __metadata('design:type', rxjs.Observable)],
      TenantsComponent.prototype,
      'totalCount$',
      void 0,
    );
  ...
  var TenantManagementStateService = /** @class */ (function() {
    ...
    /** @nocollapse */ TenantManagementStateService.ngInjectableDef = core.ɵɵdefineInjectable({
      factory: function TenantManagementStateService_Factory() {
        return new TenantManagementStateService(core.ɵɵinject(store.Store));
      },
