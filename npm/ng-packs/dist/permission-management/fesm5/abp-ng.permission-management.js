...
var PermissionManagementComponent = /** @class */ (function() {
  ...
  __decorate(
    [Select(PermissionManagementState.getPermissionGroups), __metadata('design:type', Observable)],
    PermissionManagementComponent.prototype,
    'groups$',
    void 0,
  );
  __decorate(
    [Select(PermissionManagementState.getEntitiyDisplayName), __metadata('design:type', Observable)],
    PermissionManagementComponent.prototype,
    'entityName$',
    void 0,
  );
