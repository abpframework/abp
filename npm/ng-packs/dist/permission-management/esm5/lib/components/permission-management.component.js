...
var PermissionManagementComponent = /** @class */ (function() {
        ...
        map(
          ...
          function(permissions) {
            return permissions.map(
               ...
               */
              function(permission) {
                return /** @type {?} */ /** @type {?} */ (tslib_1.__assign({}, permission, {
      ...
      function(permissions) {
        permissions.forEach(
          ...
          function(permission) {
            ...
            _this.permissions = tslib_1.__spread(
   ...
   */ = function() {
    ...
    this.permissions = this.permissions.map(
       ...
       */
      function(permission) {
        return tslib_1.__assign({}, permission, { isGranted: !_this.selectAllTab });
      },
    );
  ...
  PermissionManagementComponent.ctorParameters = function() {
    return [{ type: Store }, { type: Renderer2 }];
  };
  ...
  tslib_1.__decorate(
    [Select(PermissionManagementState.getPermissionGroups), tslib_1.__metadata('design:type', Observable)],
    PermissionManagementComponent.prototype,
    'groups$',
    void 0,
  );
  tslib_1.__decorate(
    [Select(PermissionManagementState.getEntitiyDisplayName), tslib_1.__metadata('design:type', Observable)],
    PermissionManagementComponent.prototype,
    'entityName$',
    void 0,
  );
...
function getPermissions(groups) {
  return groups.reduce(
     ...
     */
    function(acc, val) {
      return tslib_1.__spread(acc, val.permissions);
    },
    [],
  );
}
