(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@abp/ng.core'), require('@angular/router'), require('snq'), require('@abp/ng.theme.shared')) :
    typeof define === 'function' && define.amd ? define('@abp/ng.setting-management', ['exports', '@angular/core', '@abp/ng.core', '@angular/router', 'snq', '@abp/ng.theme.shared'], factory) :
    (global = global || self, factory((global.abp = global.abp || {}, global.abp.ng = global.abp.ng || {}, global.abp.ng['setting-management'] = {}), global.ng.core, global.ng_core, global.ng.router, global.snq, global.ng_theme_shared));
}(this, function (exports, core, ng_core, router, snq, ng_theme_shared) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var SettingManagementModule = /** @class */ (function () {
        ...
        SettingManagementModule.ctorParameters = function () { return [
            { type: InitialService, decorators: [{ type: core.Self }] }
        ]; };
    ...
    exports.RootSettingManagementModule = RootSettingManagementModule;
    ...
    exports.ɵb = InitialService;
    exports.ɵc = SettingManagementRoutingModule;
