(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('@angular/core'), require('@abp/ng.core'))
    : typeof define === 'function' && define.amd
    ? define('@abp/ng.tenant-management.config', ['exports', '@angular/core', '@abp/ng.core'], factory)
    : ((global = global || self),
      factory(
        ((global.abp = global.abp || {}),
        (global.abp.ng = global.abp.ng || {}),
        (global.abp.ng['tenant-management'] = global.abp.ng['tenant-management'] || {}),
        (global.abp.ng['tenant-management'].config = {})),
        global.ng.core,
        global.ng_core,
      ));
})(this, function(exports, core, ng_core) {
  'use strict';
  ...
  var TenantManagementConfigService = /** @class */ (function() {
    ...
    /** @nocollapse */ TenantManagementConfigService.ngInjectableDef = core.ɵɵdefineInjectable({
    ...
    TenantManagementConfigModule.decorators = [
      {
        ...
        args: [
          {
            providers: [
              { provide: core.APP_INITIALIZER, deps: [TenantManagementConfigService], useFactory: ɵ0, multi: true },
            ],
          },
        ],
      },
