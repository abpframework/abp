...
* **[`upgrade`](../cli#switch-to-local)**: It converts the application to use pro modules.
* **[`translate`](../cli#help)**: Simplifies to translate localization files when you have multiple JSON [localization](../framework/fundamentals/localization.md) files in a source control repository.
