...
public class RemoteCurrentPrincipalAccessorBase : CurrentPrincipalAccessorBase, ITransientDependency
{
    protected ApplicationConfigurationCache ApplicationConfigurationCache { get; }

    public RemoteCurrentPrincipalAccessorBase(ApplicationConfigurationCache applicationConfigurationCache)
    {
    ...
    protected override ClaimsPrincipal GetClaimsPrincipal()
    {
        ...
        return new ClaimsPrincipal(new ClaimsIdentity(claims, authenticationType: nameof(RemoteCurrentPrincipalAccessorBase)));
    }
}
