...
using MyCompanyName.MyProjectName.Blazor.Server.WebApp.Tiered.Client;
using MyCompanyName.MyProjectName.Blazor.Server.WebApp.Tiered.Components;
using MyCompanyName.MyProjectName.Blazor.Server.WebApp.Tiered.Menus;
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/MyCompanyName.MyProjectName.Blazor.Server.WebApp.Tiered.Client.styles.css");
                }
            );
        });
    }
