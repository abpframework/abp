...
namespace MyCompanyName.MyProjectName.Web.Theme.Themes.MyProjectName.Components.Toolbar
{
    public class MainNavbarToolbarViewComponent : AbpViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View("~/Themes/MyProjectName/Components/Toolbar/Default.cshtml", toolbar);
        }
    }
}
