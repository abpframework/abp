...
$projects = (
    ...
    "modules/account/src/Volo.Abp.Account.Blazor.MudBlazor",
    ...
    # modules/basic-theme (MudBlazor)
    "modules/basic-theme/src/Volo.Abp.AspNetCore.Components.Server.MudBlazorBasicTheme",
    "modules/basic-theme/src/Volo.Abp.AspNetCore.Components.Web.MudBlazorBasicTheme",
    "modules/basic-theme/src/Volo.Abp.AspNetCore.Components.WebAssembly.MudBlazorBasicTheme",
    "modules/basic-theme/src/Volo.Abp.AspNetCore.Components.WebAssembly.MudBlazorBasicTheme.Bundling",
    ...
    "modules/feature-management/src/Volo.Abp.FeatureManagement.Blazor.MudBlazor",
    "modules/feature-management/src/Volo.Abp.FeatureManagement.Blazor.MudBlazor.Server",
    "modules/feature-management/src/Volo.Abp.FeatureManagement.Blazor.MudBlazor.WebAssembly",
    ...
    "modules/identity/src/Volo.Abp.Identity.Blazor.MudBlazor",
    "modules/identity/src/Volo.Abp.Identity.Blazor.MudBlazor.Server",
    "modules/identity/src/Volo.Abp.Identity.Blazor.MudBlazor.WebAssembly",
    ...
    "modules/permission-management/src/Volo.Abp.PermissionManagement.Blazor.MudBlazor",
    "modules/permission-management/src/Volo.Abp.PermissionManagement.Blazor.MudBlazor.Server",
    "modules/permission-management/src/Volo.Abp.PermissionManagement.Blazor.MudBlazor.WebAssembly",
    ...
    "modules/setting-management/src/Volo.Abp.SettingManagement.Blazor.MudBlazor",
    "modules/setting-management/src/Volo.Abp.SettingManagement.Blazor.MudBlazor.Server",
    "modules/setting-management/src/Volo.Abp.SettingManagement.Blazor.MudBlazor.WebAssembly",
    ...
    "modules/tenant-management/src/Volo.Abp.TenantManagement.Blazor.MudBlazor",
    "modules/tenant-management/src/Volo.Abp.TenantManagement.Blazor.MudBlazor.Server",
    "modules/tenant-management/src/Volo.Abp.TenantManagement.Blazor.MudBlazor.WebAssembly",
