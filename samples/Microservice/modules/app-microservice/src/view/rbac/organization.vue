  ...
  <Card class="album">
    <Row :gutter="16">
      <Col span="24" class="dnc-toolbar-btns">
        <Button icon="md-create" type="primary" @click="add" title="新增部门">新增部门</Button>
      </Col>
    </Row>
        ...
        <Row>
          <Col span="24">
            <FormItem label-position="left">
              <Input v-model="formModel.parentName" placeholder="请选择上级部门" :readonly="true">
