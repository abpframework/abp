...
namespace Volo.Abp.AspNetCore.Mvc.Versioning
{
    ...
    public class AspNetCoreMvcVersioningTestModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                //2.0 Version
                options.ConventionalControllers.Create(typeof(AspNetCoreMvcVersioningTestModule).Assembly, opts =>
                {
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            context.Services.AddHttpClientProxies(typeof(AspNetCoreMvcVersioningTestModule).Assembly);
