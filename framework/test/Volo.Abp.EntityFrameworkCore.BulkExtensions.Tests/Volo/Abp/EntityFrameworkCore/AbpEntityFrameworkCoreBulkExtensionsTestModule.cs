...
using Volo.Abp.EntityFrameworkCore.BulkOperations.BulkExtensions.Volo.Abp.EntityFrameworkCore;
...
namespace Volo.Abp.EntityFrameworkCore.BulkExtensions.Tests.Volo.Abp.EntityFrameworkCore
{
    [DependsOn(typeof(AbpEntityFrameworkCoreSqliteModule))]
    [DependsOn(typeof(TestAppModule))]
    [DependsOn(typeof(AbpAutofacModule))]
    [DependsOn(typeof(AbpEfCoreTestSecondContextModule))]
    [DependsOn(typeof(AbpEntityFrameworkCoreBulkExtensionsModule))]

    public class AbpEntityFrameworkCoreBulkExtensionsTestModule : AbpModule
    {
