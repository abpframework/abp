...
public class ClosedXmlExcelExporter_Tests : AbpDataExportingExcelTestBase
{
    private readonly IExcelExporter _excelExporter;

    public ClosedXmlExcelExporter_Tests()
    {
        var excelExporters = GetRequiredService<IEnumerable<IExcelExporter>>();
        _excelExporter = excelExporters.FirstOrDefault(c => c.Name.Equals(ClosedXmlExcelExporter.EngineName));
    }

    [Fact]
    public async Task Export_Excel_ClosedXml_Test()
    {
