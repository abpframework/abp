...
public class NpoiExcelExporter_Tests : AbpDataExportingExcelTestBase
{
    private readonly IExcelExporter _excelExporter;

    public NpoiExcelExporter_Tests()
    {
        var excelExporters = GetRequiredService<IEnumerable<IExcelExporter>>();
        _excelExporter = excelExporters.FirstOrDefault(c => c.Name.Equals(NpoiExcelExporter.EngineName));
    }

    [Fact]
    public async Task Export_Excel_Npoi_Test()
    {
