...
public class DefaultHuaweiCloudBlobNamingNormalizerProvider_Tests : AbpBlobStoringHuaweiCloudTestCommonBase
{
    private readonly IBlobNamingNormalizer _blobNamingNormalizer;

    public DefaultHuaweiCloudBlobNamingNormalizerProvider_Tests()
    {
