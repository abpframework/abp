...
{
    public class DefaultHuaweiyunBlobNamingNormalizerProvider_Tests: AbpBlobStoringHuaweiyunTestCommonBase
    {
        private readonly IBlobNamingNormalizer _blobNamingNormalizer;

        public DefaultHuaweiyunBlobNamingNormalizerProvider_Tests()
        {
