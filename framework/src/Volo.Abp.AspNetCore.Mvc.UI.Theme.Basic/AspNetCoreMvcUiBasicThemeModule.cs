...
namespace Volo.Abp.AspNetCore.Mvc.UI.Theme.Basic
{
    ...
    public class AspNetCoreMvcUiBasicThemeModule : AbpModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                options.FileSets.AddEmbedded<AspNetCoreMvcUiBasicThemeModule>("Volo.Abp.AspNetCore.Mvc.UI.Theme.Basic");
            });
