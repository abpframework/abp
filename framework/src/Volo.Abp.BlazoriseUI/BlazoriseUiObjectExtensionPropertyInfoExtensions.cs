...
{
    private readonly static HashSet<Type> NumberTypes = new HashSet<Type> {
            typeof(int),
            typeof(long),
            typeof(byte),
            typeof(sbyte),
    ...
    private readonly static HashSet<Type> TextEditSupportedAttributeTypes = new HashSet<Type> {
