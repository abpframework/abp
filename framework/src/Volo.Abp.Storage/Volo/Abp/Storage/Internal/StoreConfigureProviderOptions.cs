...
{
    public class StoreConfigureProviderOptions<TParsedOptions, TInstanceOptions, TStoreOptions,
            TScopedStoreOptions> : IConfigureOptions<TParsedOptions>
        ...
        where TScopedStoreOptions : class, TStoreOptions, IScopedStoreOptions, new()
    {
        ...
        public StoreConfigureProviderOptions(IOptions<AbpStorageOptions> storageOptions)
        {
        ...
        {
            if (_storageOptions == null) return;
            ...
            foreach (var parsedProviderInstance in options.ParsedProviderInstances)
                parsedProviderInstance.Value
                    .Compute<TParsedOptions, TInstanceOptions, TStoreOptions, TScopedStoreOptions>(options);
