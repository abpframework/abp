...
public class BlazorWebAssemblyStyleContributor : BundleContributor
{
    ...
    {
        context.Files.AddIfNotContains("_content/Volo.Abp.AspNetCore.Components.WebAssembly.Theming.Bundling/libs/bootstrap/css/bootstrap.min.css");
        context.Files.AddIfNotContains("_content/Volo.Abp.AspNetCore.Components.WebAssembly.Theming.Bundling/libs/fontawesome/css/all.css");
        context.Files.AddIfNotContains("_content/Volo.Abp.AspNetCore.Components.Web/libs/abp/css/abp.css");
        context.Files.AddIfNotContains("_content/Volo.Abp.AspNetCore.Components.WebAssembly.Theming.Bundling/libs/flag-icon/css/flag-icon.css");
