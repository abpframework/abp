...
public class BlazorWebAssemblyMudBlazorStyleContributor : BundleContributor
{
    ...
    {
        context.Files.AddIfNotContains("_content/Volo.Abp.AspNetCore.Components.WebAssembly.Theming.MudBlazor/libs/fontawesome/css/all.css");
        ...
        context.Files.AddIfNotContains("_content/Volo.Abp.AspNetCore.Components.WebAssembly.Theming.MudBlazor/libs/flag-icon/css/flag-icon.css");
    }
}
