...
namespace Volo.Blogging
{
    public class BloggingPermissionDefinitionProvider : PermissionDefinitionProvider
    {
        ...
        {
            var qaGroup = context.AddGroup(BloggingPermissions.GroupName, L("Permission:Blogging"));

            var blogs = qaGroup.AddPermission(BloggingPermissions.Blogs.Default, L("Permission:BlogManagement"));
            ...
            var posts = qaGroup.AddPermission(BloggingPermissions.Posts.Default, L("Permission:PostManagement"));
