...
namespace Volo.Abp.FeatureManagement
{
    ...
    public class FeatureManagementWebModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                options.AddAssemblyResource(typeof(AbpFeatureManagementResource), typeof(FeatureManagementWebModule).Assembly);
            });
        }
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                options.FileSets.AddEmbedded<FeatureManagementWebModule>("Volo.Abp.FeatureManagement");
            });
