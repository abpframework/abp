						...
						items: [
							{
								...
								action: function (data) {
									service.removeFromCache(data.record.id).then(function () {
							...
							},
							{
								...
								action: function (data) {
									service.reindex(data.record.id).then(function () {
							...
							},
							{
								...
								visible: abp.auth.isGranted('Docs.Admin.Documents'),
								confirmMessage: function (data) {
									return l('DeleteDocumentFromDbConfirmation');
								},
								action: function (data) {
									service.deleteFromDatabase(data.record.id).then(function () {
